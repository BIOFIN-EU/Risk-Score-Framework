...
class TestBioRiskPlusFISComponents(unittest.TestCase):
    ...
    #     output1 = self.fis.run_single(**{
    #         'ch': 1,
    #         'pa': 1,
    #         'si': np.float64(0.24289999902248383)
    #     })
    #     output2 = self.fis.run_single(**{
    #         'ch': 1,
    #         'pa': 1,
    #         'si': np.float64(0.24289199902248383)
    #     })
    #     output3 = self.fis.run_single(**{
    #         'ch': 1,
    #         'pa': 1,
    ...
    #     exec_ids = self.fis.fis_sim._calculated
    ...
    def test_fis_evaluate_exec_time(self):
        self.fis = BioRiskPlusFIS(sri_rounding=4)
        shape=(334, 463)
        rows, cols = shape
